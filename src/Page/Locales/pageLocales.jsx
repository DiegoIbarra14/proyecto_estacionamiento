...
const PageLocales = () => {
  ...
  const [locales, setLocales] = useState([
    ...
    // Puedes añadir más locales según tus necesidades
  ]);
  ...
  const [areaDialogVisible, setAreaDialogVisible] = useState(false); // Popup de Crear Área

  const [crearEspaciosDialogVisible, setCrearEspaciosDialogVisible] = useState(false); // Nuevo Popup para Crear Espacios
  ...
  // Opciones para el Dropdown de "Estado espacio"
  const estadosEspacio = [
    { label: 'Activo', value: 'Activo' },
    { label: 'Inactivo', value: 'Inactivo' },
    { label: 'En Mantenimiento', value: 'En Mantenimiento' },
    // Añade más estados según tus necesidades
  ];
