    ...
    return (
      <>
        <div className='container-search'>
          <div className='lista'>
            <h1 className='lista-h1'>Detalles del Pedido</h1>
            
          </div>
        </div>
        <div>
          <div className='flex justify-content-between' style={{marginRight:"10px"}}>
...
export default ListPedidoDetalle;
