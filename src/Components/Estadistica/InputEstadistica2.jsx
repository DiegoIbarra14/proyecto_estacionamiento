...
function InputEstadistica(props) {
  const panelFooterProductos = () => {
    const selectedProductos = props.valueProducto;
    const length = selectedProductos ? selectedProductos.length : 0;
    return (
        ...
        <div className="card-input-estadistica">
          ...
          <div className="field section-input">
            ...
            <MultiSelect
              ...
              style={{ width: "100%" }}
              filter
              panelFooterTemplate={panelFooterProductos}
            />
