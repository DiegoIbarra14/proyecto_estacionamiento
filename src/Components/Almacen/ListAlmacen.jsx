...
function ListAlmacen(props) {
    ...
    return (
      <>
        <div className="container-search">
          <div className="lista">
            <h1 className="lista-h1">{props.title}</h1>
          </div>
        </div>
        <div>
  ...
  return (
    <div className="card-table-almacen">
      ...
      <DataTable
        ...
        paginatorLeft={props.paginatorLeft == null ? null : paginatorLeft}
        paginatorRight={props.paginatorLeft == null ? null : paginatorRight}
      >
        {props.children}
      </DataTable>
    </div>
